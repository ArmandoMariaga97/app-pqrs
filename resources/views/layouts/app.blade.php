...
<head>
  ...
  <!-- apline.js -->
  <script src="{{ asset('js/alpine.min.js')}}" type="text/javascript"></script>
  @livewireStyles
</head>
...
data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
  ...
  <script src="{{ asset('modernadmin/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js')}}"
  type="text/javascript"></script>
  <script src="{{ asset('modernadmin/app-assets/vendors/js/forms/icheck/icheck.min.js')}}" type="text/javascript"></script>
  <!-- END PAGE VENDOR JS-->
  <!-- BEGIN MODERN JS-->
  ...
  <!-- END MODERN JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <script src="{{ asset('modernadmin/app-assets/js/scripts/forms/form-login-register.js')}}" type="text/javascript"></script>
  <!-- END PAGE LEVEL JS-->
</body>
</html>